...
import (
	_ "github.com/CSCI-2390-Project/grpc-go/xds/internal/balancer"  // Register the balancers.
	_ "github.com/CSCI-2390-Project/grpc-go/xds/internal/client/v2" // Register the v2 xDS API client.
	_ "github.com/CSCI-2390-Project/grpc-go/xds/internal/client/v3" // Register the v3 xDS API client.
	_ "github.com/CSCI-2390-Project/grpc-go/xds/internal/resolver"  // Register the xds_resolver.
)
