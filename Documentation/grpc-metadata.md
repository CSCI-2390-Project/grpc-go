...
A metadata can be created using package [metadata](https://godoc.org/github.com/CSCI-2390-Project/grpc-go/metadata).
...
Header and trailer sent along with a unary call can be retrieved using function [Header](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#Header) and [Trailer](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#Trailer) in [CallOption](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#CallOption):
...
Header and trailer can be retrieved from the returned stream using function `Header` and `Trailer` in interface [ClientStream](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#ClientStream):
...
To send header and trailer to client in unary call, the server can call [SendHeader](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#SendHeader) and [SetTrailer](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#SetTrailer) functions in module [grpc](https://godoc.org/github.com/CSCI-2390-Project/grpc-go).
...
For streaming calls, header and trailer can be sent using function `SendHeader` and `SetTrailer` in interface [ServerStream](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#ServerStream):
