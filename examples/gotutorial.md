...
```shell
$ go get github.com/CSCI-2390-Project/grpc-go
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/CSCI-2390-Project/grpc-go/examples/route_guide
```
...
`$GOPATH/src/github.com/CSCI-2390-Project/grpc-go/examples/route_guide`, simply:
