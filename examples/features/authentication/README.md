...
[`credentials.PerRPCCredentials`](https://godoc.org/github.com/CSCI-2390-Project/grpc-go/credentials#PerRPCCredentials).
...
https://godoc.org/github.com/CSCI-2390-Project/grpc-go/credentials/oauth for details.

#### Client

On client side, users should first get a valid oauth token, and then call
[`credentials.NewOauthAccess`](https://godoc.org/github.com/CSCI-2390-Project/grpc-go/credentials/oauth#NewOauthAccess)
...
[`WithPerRPCCredentials`](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/github.com/CSCI-2390-Project/grpc-go#PerRPCCredentials).
