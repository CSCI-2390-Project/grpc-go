...
echo "go install github.com/CSCI-2390-Project/protobuf-go/cmd/protoc-gen-go"
(cd test/tools && go install github.com/CSCI-2390-Project/protobuf-go/cmd/protoc-gen-go)
...
mkdir -p ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1

# grpc_testingv3/testv3.pb.go is not re-generated because it was
# intentionally generated by an older version of protoc-gen-go.
rm ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/reflection/grpc_testingv3/*.pb.go
...
mkdir -p ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/credentials/tls/certprovider/meshca/internal/v1/
mv ${WORKDIR}/out/istio/google/security/meshca/v1/* ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/credentials/tls/certprovider/meshca/internal/v1/

cp -R ${WORKDIR}/out/github.com/CSCI-2390-Project/grpc-go/* .
