...
import (
	...
	_ "github.com/CSCI-2390-Project/grpc-go/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/CSCI-2390-Project/grpc-go/internal/resolver/passthrough" // passthrough resolver.
)
